...
export const API_ENDPOINTS = {
  ...
  GROUPS: {
    ...
    REMOVE_STUDENT: (groupId: string, studentId: string) =>
  ...
  SCHEDULES: {
    ...
    GENERATE_SESSIONS: (groupId: string) =>
  ...
  ATTENDANCE: {
    ...
    HOMEWORK_ONSITE: (sessionId: string) =>
      `/attendance/sessions/${sessionId}/homework-onsite`,
