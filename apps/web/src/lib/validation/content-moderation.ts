...
const PROFANITY_PATTERNS: RegExp[] = [
  ...
  /(قليل\s*(الادب|الأدب)|قليلة\s*(الادب|الأدب)|عديم\s*(الادب|الأدب|التربية|التربيه)|مش\s*(متربي|متربيه|متربية|محترم|محترمه|محترمة)|انت\s*(مش\s*)?محترم|انتي\s*(مش\s*)?محترمه|انتي\s*(مش\s*)?محترمة)/,
