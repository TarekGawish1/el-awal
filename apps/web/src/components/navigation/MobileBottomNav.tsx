...
export function MobileBottomNav({ userRole, onOpenMobileMenu }: MobileBottomNavProps) {
  ...
  return (
    <nav
      ...
      className="lg:hidden fixed bottom-0 inset-x-0 bg-white/95 backdrop-blur-md border-t border-neutral-200/90 z-30 pb-safe shadow-lg shadow-neutral-900/5 transition-all"
    >
