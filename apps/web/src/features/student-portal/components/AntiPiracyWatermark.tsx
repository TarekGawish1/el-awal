...
export function AntiPiracyWatermark({
  ...
  return (
    ...
    >
      <div className="bg-black/25 backdrop-blur-[1px] px-2.5 py-1 rounded-md border border-white/10 text-white/25 text-[11px] font-mono whitespace-nowrap shadow-sm">
        {watermarkText}
      </div>
    </div>
  );
