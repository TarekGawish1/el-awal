...
import { UserPlus, Mail, Phone, Loader2, Check, ShieldAlert, Users, Calendar, Banknote } from 'lucide-react';
...
export function InviteAssistantForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess('تم إنشاء الحساب وإضافة المساعد بنجاح!');
      setPhone('');
      setEmail('');
      setFullName('');
      setPassword('');
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden p-6">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <div className="flex justify-end pt-4 border-t border-neutral-100">
          <button
            type="submit"
            disabled={!phone.trim() || !fullName.trim() || !password || isInviting}
