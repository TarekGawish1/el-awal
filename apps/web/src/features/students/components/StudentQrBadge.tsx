      ...
      img.onload = async () => {
        ...
        if (ctx) {
          ...
          canvas.toBlob(async (blob) => {
            if (!blob) return;
            const file = new File([blob], `student-qr-${data.studentCode}.png`, { type: 'image/png' });
