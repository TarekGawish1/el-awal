    ...
    <footer className="bg-slate-900 text-slate-300 py-8 border-t border-slate-800" dir="rtl">
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-6">
          <a href="#" className="hover:text-blue-400 transition-colors text-sm font-medium">شروط الاستخدام</a>
          <a href="#" className="hover:text-blue-400 transition-colors text-sm font-medium">سياسة الخصوصية</a>
          <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors flex items-center gap-2 text-sm font-medium">
