...
export declare class StudentsController {
    ...
    getStudentById(id: string, user: AuthenticatedUser): Promise<{
        user: {
            id: string;
            email: string;
            phone: string;
    ...
    getStudentQrCode(id: string, user: AuthenticatedUser): Promise<StudentQrCodeResponseDto>;
    regenerateQrToken(id: string, user: AuthenticatedUser): Promise<StudentQrCodeResponseDto>;
}
