...
exports.CoursesModule = CoursesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [courses_service_1.CoursesService, course_progress_repository_1.CourseProgressRepository],
        exports: [courses_service_1.CoursesService, course_progress_repository_1.CourseProgressRepository],
    })
], CoursesModule);
