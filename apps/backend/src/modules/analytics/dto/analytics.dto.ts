...
export class TrackPageViewDto {
  ...
  @ApiPropertyOptional({
    description: "Whether the visited page is the public landing page",
    default: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: "Tenant ID if scoped to a specific teacher workspace",
  ...
  @ApiPropertyOptional({
    description:
      "Optional extensible metadata (UTM tags, device info, screen dimensions)",
  })
  @IsOptional()
  @IsObject()
  ...
  @ApiPropertyOptional({
    description: "Client-detected city/governorate",
    example: "دمياط",
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: "Client-detected country",
    example: "مصر",
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description:
      "Persistent client device visitor ID for multi-device Wi-Fi isolation",
    example: "vid_1a2b3c4d",
  })
  @IsOptional()
  @IsString()
  visitorId?: string;
...
export class AnalyticsQueryDto {
  @ApiPropertyOptional({
    description:
      "Filter scope: landing page only, system dashboard only, or combined",
  ...
  @ApiPropertyOptional({
    description: "Optional tenant filter if requesting platform-wide analytics",
  })
  @IsOptional()
  @IsString()
  tenantId?: string;
...
export class StartSessionDto {
  @ApiPropertyOptional({
    description: "Tenant ID / Teacher Profile ID associated with the session",
  })
  @IsOptional()
  @IsString()
  tenantId?: string;
...
export class PingSessionDto {
  @ApiProperty({
    ...
    example: "b6e3f282-e30c-4395-814e-f82ad31057e0",
  })
  @IsUUID()
  sessionId: string;

  @ApiPropertyOptional({
    description: "Elapsed active seconds since last ping",
    default: 30,
  })
  @IsOptional()
  @IsNumber()
...
export class GeoRankingQueryDto {
  @ApiPropertyOptional({
    description:
      "Filter scope: landing visits, platform user sessions, or all combined",
...
export class StudentRankingQueryDto {
  @ApiPropertyOptional({
    description:
      "Sort leaderboard by total active duration or total session visit count",
...
export class VisitorListQueryDto {
  ...
  @ApiPropertyOptional({
    description: "Search keyword (name, phone, studentCode, city)",
  })
  @IsOptional()
  @IsString()
  search?: string;
